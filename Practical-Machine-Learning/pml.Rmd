...
```
The out of sample error is the error you get on a new data set.  This will always be greater than in sample error.  The accuracy of the model is 0.993, indicate=ing that the prediction model is also very accurate on the testing set.
